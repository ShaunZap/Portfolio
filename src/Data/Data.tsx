...
export const projectData: ProjectData[] = [
  ...
  {
    projectImage: imageIcons.portfolioIcon,
    projectTitle: "Potfolio",
    projectDescription:
      "A sleek, mobile-first portfolio site featuring a homepage with quotes and news, and sections like About, Projects, Experience, Education, and Skills as app-like pages. Includes a bottom navigation bar for easy access to Info, Home, and Resume. Designed for smooth, app-style user experience",
    techStackIcons: [
      {
      ...
      {
        icon: imageIcons.framericon,
        name: "Framer Motion",
      },
    ],
    projectLinks: {
      live: "https://portfolio-seven-omega-20.vercel.app/",
      github: "https://github.com/ShaunZap/Portfolio",
    },
  },
  {
...
export const skillsData: SkillsData = {
  frontendData: [
    ...
    },
    {
      ...
      description:
        "Framer Motion is a powerful animation library for React that enables smooth, interactive animations and transitions with minimal effort.",
      highlights: ["Animations", "Transitions", "Gestures"],
      moreInfoLink: "https://motion.dev/",
    },
    {
      title: "Tailwind CSS",
      icon: imageIcons.tailwindIcon,
